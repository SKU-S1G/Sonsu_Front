  ...
  return (
    <ScrollView style={[tailwind("flex-1"), { backgroundColor: "#f5f5f5" }]}>
      ...
      <TouchableOpacity
        style={[
          tailwind(
            "flex-row justify-center items-center bg-yellow-200 mt-5 mb-10"
          ),
          styles.gameBox,
        ]}
        // onPress={() => navigation.navigate("SpeedInfo")}
      >
        ...
        <View style={styles.textContainer}>
          <Image
            source={require("../../../assets/images/LyricsQuiz.png")}
            style={styles.imageTitle}
          />
      ...
      <View
        style={tailwind(
          "flex-row justify-between items-center mt-2 mb-2 mx-10"
        )}
      >
